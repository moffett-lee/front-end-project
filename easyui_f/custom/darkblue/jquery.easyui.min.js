...
p.panel("panel").animate(_3c8.collapse,_3c1,function(){
	if(p.panel("panel").is('.layout-panel-north')){
		//setTimeout(function(){$(".layout-expand-north").height(40)}, 0)
...
$.fn.layout.paneldefaults=$.extend({},$.fn.panel.defaults,{region:null,split:false,collapsedSize:41,expandMode:"float",hideExpandTool:false,hideCollapsedContent:true,collapsedContent:function(_3f6){
var p=$(this);
